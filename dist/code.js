      ...
      "golden-hour": {
        light: {
          color: {
            ...
            gradient: {
              accent: {
                value: "linear-gradient(135deg, #18BC8C 0%, #14A075 100%)",
                type: "gradient"
              },
              card: {
                value: "linear-gradient(135deg, #FFDB01 0%, #FFC700 100%)",
                type: "gradient"
              },
              header: {
                value: "linear-gradient(135deg, #FFDB01 0%, #FFC700 100%)",
        ...
        dark: {
          color: {
            ...
            gradient: {
              accent: {
                value: "linear-gradient(135deg, #5FD4B0 0%, #3EB8AF 100%)",
                type: "gradient"
              },
              card: {
                value: "linear-gradient(135deg, #2E2E2E 0%, #252525 100%)",
                type: "gradient"
              },
              header: {
                value: "linear-gradient(135deg, #2A2A00 0%, #1F1F00 100%)",
                type: "gradient"
              }
            },
            card: {
